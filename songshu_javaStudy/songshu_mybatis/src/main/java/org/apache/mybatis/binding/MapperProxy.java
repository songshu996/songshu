...
import org.apache.mybatis.reflection.ExceptionUtil;
import org.apache.mybatis.session.SqlSession;
import org.apache.mybatis.util.MapUtil;
...
public class MapperProxy<T> implements InvocationHandler, Serializable {
  ...
  static {
    ...
    try {
      //从Class和Lookup中寻找privateLookupIn方法
  ...
  /**
   * 将传入的方法封装成一个MapperMethodInvoker
   * @param method
   * @return
   * @throws Throwable
   */
